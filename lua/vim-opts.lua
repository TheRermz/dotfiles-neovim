...
vim.cmd("set wrap") -- quebra linha visualmente
vim.cmd("set linebreak") -- quebra em palavras inteiras, não no meio
vim.cmd("set breakindent") -- mantém indentação nas linhas quebradas
